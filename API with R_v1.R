...
req <- request("https://planets-by-api-ninjas.p.rapidapi.com") %>%
  ...
  req_headers('X-RapidAPI-Key' = 'd90e49cb20msh63c969b6d6473cdp1741f3jsn648bacf73384',
...
# POST with rapid API -----------------------------------------------------
req <- request("https://google-translate113.p.rapidapi.com/api/v1/translator/text") %>% 
  req_headers('X-RapidAPI-Key' = "d90e49cb20msh63c969b6d6473cdp1741f3jsn648bacf73384",
              'X-RapidAPI-Host' = 'google-translate113.p.rapidapi.com' ) %>%
  req_body_json(list(text = "Hello, world!",
                     from = "en",
                     to = "da"))
